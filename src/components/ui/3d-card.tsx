...
// Provider + Wrapper for 3D hover container
...
// Body inside the 3D card container
...
// Individual items with 3D animation based on hover
...
// Hook to consume mouse enter state
